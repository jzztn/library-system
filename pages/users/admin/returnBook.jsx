	...
	return (
		<div className="h-screen grid grid-cols-[auto,1fr]">
			...
			<div className="grid grid-rows-[auto,1fr,auto] gap-10 px-10 py-7">
				<h1 className="font-semibold mr-auto">RETURN BOOK</h1>
				...
				<div className="flex flex-col gap-6">
					...
					<div className="bg-gradient-to-b from-blue-300 to-blue-600 text-white p-5 mt-20">
						<h1 className="text-md font-semibold">TAX PENALTY</h1>
						<h1 className="text-xl font-semibold border-b-white border-t-0 border-l-0 border-r-0 border-[1px] my-3">TOTAL: ₱ 20.00 </h1>
						<p className="text-sm opacity-80">₱ 1.50 per day</p>
					</div>
				</div>
				...
				<div>
					<button
						...
						className="bg-gradient-to-b from-blue-300 to-blue-600 text-white py-4 px-8 text-xs tracking-wider rounded-sm">RETURN</button>
				</div>
			</div>
		</div>
	)
